...
_f_acc_urea = OrderedDict{String, OrderedDict{String, Float32}}(
    "ALA" => OrderedDict("n"=>179233, "sc"=> 70.878, "sc_pure"=>135.348, "bb"=>49.0121, "bb_pure"=>88.8883, "f_bb"=>0.591726618, "f_sc"=>0.523674),
    "PHE" => OrderedDict("n"=> 91323, "sc"=>187.587, "sc_pure"=>248.851, "bb"=>38.6632, "bb_pure"=>87.3740, "f_bb"=>0.696043165, "f_sc"=>0.753811),
    "LEU" => OrderedDict("n"=>213010, "sc"=>159.140, "sc_pure"=>219.486, "bb"=>37.3229, "bb_pure"=>88.2639, "f_bb"=>0.649280575, "f_sc"=>0.725056),
    "ILE" => OrderedDict("n"=>126589, "sc"=>159.817, "sc_pure"=>220.105, "bb"=>35.3226, "bb_pure"=>87.5728, "f_bb"=>0.714028776, "f_sc"=>0.726092),
    "VAL" => OrderedDict("n"=>153028, "sc"=>133.941, "sc_pure"=>194.604, "bb"=>36.6751, "bb_pure"=>87.2728, "f_bb"=>0.643884892, "f_sc"=>0.688274),
    "PRO" => OrderedDict("n"=> 97983, "sc"=>130.021, "sc_pure"=>192.851, "bb"=>39.6460, "bb_pure"=>91.4236, "f_bb"=>0.357913669, "f_sc"=>0.674206),
    "MET" => OrderedDict("n"=> 36719, "sc"=>161.456, "sc_pure"=>222.969, "bb"=>39.9090, "bb_pure"=>87.8564, "f_bb"=>0.741007194, "f_sc"=>0.724115),
    "TRP" => OrderedDict("n"=> 31497, "sc"=>230.509, "sc_pure"=>291.634, "bb"=>37.4479, "bb_pure"=>88.0122, "f_bb"=>0.821942446, "f_sc"=>0.790406),
    "GLY" => OrderedDict("n"=>151702, "sc"=>  0.000, "sc_pure"=>  0.000, "bb"=>87.4824, "bb_pure"=>87.4824, "f_bb"=>1.0        , "f_sc"=>1.000000),
    "SER" => OrderedDict("n"=>129971, "sc"=> 85.274, "sc_pure"=>148.711, "bb"=>45.9041, "bb_pure"=>87.7078, "f_bb"=>0.667266187, "f_sc"=>0.573423),
    "THR" => OrderedDict("n"=>118719, "sc"=>117.741, "sc_pure"=>179.107, "bb"=>39.4432, "bb_pure"=>87.0271, "f_bb"=>0.580935251, "f_sc"=>0.657378),
    "TYR" => OrderedDict("n"=> 78202, "sc"=>202.043, "sc_pure"=>263.305, "bb"=>38.8600, "bb_pure"=>87.3211, "f_bb"=>0.751798561, "f_sc"=>0.767335),
    "GLN" => OrderedDict("n"=> 82612, "sc"=>156.603, "sc_pure"=>218.196, "bb"=>40.2219, "bb_pure"=>88.4311, "f_bb"=>0.706834532, "f_sc"=>0.717718),
    "ASN" => OrderedDict("n"=> 93411, "sc"=>129.155, "sc_pure"=>191.405, "bb"=>40.9267, "bb_pure"=>88.7074, "f_bb"=>0.723021582, "f_sc"=>0.674776),
    "ASP" => OrderedDict("n"=>125837, "sc"=>121.985, "sc_pure"=>184.224, "bb"=>41.1593, "bb_pure"=>89.0758, "f_bb"=>0.762589928, "f_sc"=>0.662158),
    "GLU" => OrderedDict("n"=>142356, "sc"=>149.532, "sc_pure"=>211.134, "bb"=>40.8443, "bb_pure"=>89.0380, "f_bb"=>0.723021582, "f_sc"=>0.708232),
    "HIS" => OrderedDict("n"=> 51092, "sc"=>165.044, "sc_pure"=>226.829, "bb"=>40.1720, "bb_pure"=>87.7198, "f_bb"=>0.769784172, "f_sc"=>0.727611),
    "LYS" => OrderedDict("n"=>117537, "sc"=>178.395, "sc_pure"=>240.241, "bb"=>41.6446, "bb_pure"=>88.6705, "f_bb"=>0.616906474, "f_sc"=>0.742567),
    "ARG" => OrderedDict("n"=>110038, "sc"=>210.225, "sc_pure"=>272.220, "bb"=>41.3190, "bb_pure"=>88.3584, "f_bb"=>0.595323741, "f_sc"=>0.772262),
    "CYS" => OrderedDict("n"=> 29556, "sc"=> 92.482, "sc_pure"=>155.731, "bb"=>44.9360, "bb_pure"=>87.0777, "f_bb"=>0.523381294, "f_sc"=>0.593854),
)

#peptide_ALA 0.591726618
#peptide_PHE 0.696043165
#peptide_LEU 0.649280575
#peptide_ILE 0.714028776
#peptide_VAL 0.643884892
#peptide_PRO 0.357913669
#peptide_MET 0.741007194
#peptide_TRP 0.821942446
#peptide_GLY 1.0
#peptide_SER 0.667266187
#peptide_THR 0.580935251
#peptide_TYR 0.751798561
#peptide_GLN 0.706834532
#peptide_ASN 0.723021582
#peptide_ASP 0.762589928
#peptide_GLU 0.723021582
#peptide_HIS 0.769784172
#peptide_LYS 0.616906474
#peptide_ARG 0.595323741
#peptide_CYS 0.523381294
...
function model_combination_rule(::Type{Accessibility}, cosolvent, restype)
    ...
    bb_contribution = _acc * tfe_bb / f_acc(cosolvent)["GLY"]["bb_pure"]
