...
distance(x,y,z,A::Matrix; xyz_in_cols=true) = closest(x,y,z,A, xyz_in_cols=xyz_in_cols)[2]
...
distance(A::Matrix,B::Matrix; xyz_in_cols=true) = closest(A,B,xyz_in_cols=xyz_in_cols)[2]
